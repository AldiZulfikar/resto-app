            ...
            <div class="swiper-wrapper">
              ...
              <div class="swiper-slide">
                <div class="row event-item">
                  <div class="col-lg-6">
                    <img src="{{asset('/frontend-assets')}}/assets/img/event-birthday.jpg" class="img-fluid" alt="">
                  </div>
              ...
              <div class="swiper-slide">
                <div class="row event-item">
                  <div class="col-lg-6">
                    <img src="{{asset('/frontend-assets')}}/assets/img/event-private.jpg" class="img-fluid" alt="">
                  </div>
                  <div class="col-lg-6 pt-4 pt-lg-0 content">
