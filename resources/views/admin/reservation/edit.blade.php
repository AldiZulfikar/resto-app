<x-admin-layout>
    ...
    <div class="py-12">
        ...
        <div class="max-w-7xl mx-auto sm:px-6 lg:px-8">  
            <h1 class="text-white dark:text-white text-3xl mb-5">Edit Reservation</h1>
                <form method="POST" action="{{route('admin.reservation.update', $reservation->id)}}">
                    ...
                    <div class="mb-6">
                        ...
                        <input type="text" name="first_name" value="{{$reservation->first_name}}" id="base-input" class="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full p-2.5 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-blue-500 dark:focus:border-blue-500">
                        @error('first_name')
                    ...
                    <div class="mb-6">
                        ...
                        <input type="email" name="email" value="{{$reservation->email}}" id="base-input" class="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full p-2.5 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-blue-500 dark:focus:border-blue-500">
                        @error('email')
                            <div class="text-sm font-medium text-gray-900 dark:text-white">{{ $message }}</div>
                        @enderror
                    </div>
                    <div class="mb-6">
                        ...
                        <input type="text" name="tel_number" value="{{$reservation->tel_number}}" id="base-input" class="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full p-2.5 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-blue-500 dark:focus:border-blue-500">
                        @error('tel_number')
                            <div class="text-sm font-medium text-gray-900 dark:text-white">{{ $message }}</div>
                        @enderror
                    </div>
                    <div class="mb-6">
                        ...
                        <input type="datetime-local" name="res_date" value="{{$reservation->res_date->format('Y-m-d\TH:i:s')}}" id="base-input" class="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full p-2.5 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-blue-500 dark:focus:border-blue-500">
                        @error('res_date')
                            <div class="text-sm font-medium text-gray-900 dark:text-white">{{ $message }}</div>
                        @enderror
                    </div>
