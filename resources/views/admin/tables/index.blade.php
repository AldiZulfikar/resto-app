<x-admin-layout>
    ...
    <div class="py-12">
        <div class="max-w-7xl mx-auto sm:px-6 lg:px-8">
            <h1 class="text-white dark:text-white text-3xl">List of Tables</h1> 
                        ...
                        <tr class="bg-white border-b dark:bg-gray-900 dark:border-gray-700">
                            ...
                            <td class="px-6 py-4">
                                <div class="flex space-x-2">
                                    <a href="{{route('admin.tables.edit', $item->id)}}" class="font-medium text-white dark:text-gray-900 px-2 py-1 bg-white hover:bg-gray-600 hover:text-white rounded-lg">Edit</a>
